                    ...
                    <div className="row">
                        <div className="col-md-12 col-lg-4 mb-4 mb-lg-0 ">
                            <div className=" text-black">
                                <img src={bici1}
                                    className="card-img-top bici1" alt="" />
                                <div className="card-body">
                                    <div className="text-center mt-1">
                                        <h4 className="card-title">Bicicleta Scott Spark RC 900 AXS</h4>
                                        <h6 className="text-primary mb-1 pb-3">Precio: $70000</h6>
                                    </div>
                            ...
                            <div className=" text-black">
                                ...
                                <div className="card-body">
                                    <div className="text-center mt-1">
                                        ...
                                        <h6 className="text-primary mb-1 pb-3">Precio: $99999</h6>
                                    </div>
                                    <div className="d-flex flex-row justify-content-center " >
                                        <a href="https://cutt.ly/OJDdpKT"><button type="button" class="btn btn-danger flex-fill ms-1 btn-buy">Comprar Ahora</button></a>
                                    </div>
                            ...
                            <div className=" text-black">
                                ...
                                <div className="card-body">
                                    <div className="text-center mt-1">
                                        ...
                                        <h6 className="text-primary mb-1 pb-3">Precio: $154000</h6>
                                    </div>
                                    <div className="d-flex flex-row justify-content-center " >
                                        <a href="https://cutt.ly/OJDdpKT"><button type="button" class="btn btn-danger flex-fill ms-1 btn-buy">Comprar Ahora</button></a>
                                    </div>
